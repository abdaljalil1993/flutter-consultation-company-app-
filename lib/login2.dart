...
import 'package:bactapp/allreq.dart';
...
class _Login2State extends State<Login2> {
  ...
  Future userlogin() async {
    ...
    print(e2.text);
    Uri u = Uri.parse(
        "http://192.168.1.104/hala/login.php?email=${e1.text}&pass=${e2.text}");
    ...
    if (respones.statusCode == 200) {
      ...
      if (data1['result'] == "true") {
        if (data1['t'] == 1)
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => Allreq()));
        else if (data1['t'] == 2)
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => Allreq()));
        else if (data1['t'] == 3)
